  ...
  return (
    <button
      className={classNames(
        ...
        type === 'primary'
          ? 'bg-[#eca757] hover:bg-orange/90 dark:bg-[#00D5BF] dark:hover:bg-teal-400/90'
          : type === 'secondary'
  ...
  return (
    <RadixDialog.Portal>
      ...
      <RadixDialog.Content asChild>
        <motion.div
          className={classNames(
            'fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[#EFEAE6] dark:bg-[#1D2125] rounded-lg shadow-xl border border-bolt-elements-borderColor z-[9999] w-[520px] focus:outline-none',
            className,
          )}
          initial="closed"
          animate="open"
