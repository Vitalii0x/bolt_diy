  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-bolt-elements-borderColor text-bolt-elements-textPrimary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardContent = forwardRef<HTMLDivElement, CardProps>(({ className, ...props }, ref) => {
  return <div ref={ref} className={classNames('p-6 pt-5', className)} {...props} />;
});
CardContent.displayName = 'CardContent';

const CardFooter = forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
  <div ref={ref} className={classNames('flex items-center p-6 pt-5', className)} {...props} />
));
