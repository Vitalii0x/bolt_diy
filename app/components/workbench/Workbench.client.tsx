        ...
        >
          <div
            className={classNames(
              'fixed top-[57px] right-0 bottom-4.8 border-t border-b border-r border-[#c9c5c3] dark:border-[#4B525B] rounded-tr-md overflow-hidden rounded-br-md w-[var(--workbench-inner-width)] ml-[.5rem] mr-[.6rem] z-5 transition-[left,width] duration-200 bolt-ease-cubic-bezier',
              {
          ...
          >
            <div className="absolute inset-0 px-2 lg:px-0">
              <div className="h-full flex flex-col bg-bolt-elements-background-depth-2 border-l border-bolt-elements-borderColor shadow-sm overflow-hidden">
                <div className="flex items-center px-1 py-6 min-h-[var(--fix-height-tab)] max-h-[var(--fix-height-tab)] border-b border-bolt-elements-borderColor gap-1">
