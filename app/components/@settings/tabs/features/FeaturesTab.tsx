...
const FeatureSection = memo(
  ({
    ...
    >
      <div className="flex items-center gap-3">
        <div className={classNames(icon, 'text-xl text-orange-500 dark:text-teal-500')} />
        <div>
        ...
        <div className="flex items-center gap-4">
          <div
            className={classNames(
              ...
              'transition-colors duration-200',
              'text-orange-500 dark:text-teal-500',
            )}
          >
            <div className="i-ph:book" />
          </div>
          <div className="flex-1">
            <h4 className="text-sm font-medium text-bolt-elements-textPrimary group-hover:text-orange-500 dark:group-hover:text-teal-500 transition-colors">
              Prompt Library
            </h4>
          ...
          <select
            ...
            className={classNames(
              ...
              'group-hover:border-orange-500/30 dark:group-hover:border-teal-500/30',
              'transition-all duration-200',
            )}
          >
